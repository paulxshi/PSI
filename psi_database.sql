...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2026 at 06:14 AM
...
INSERT INTO `users` (`user_id`, `test_permit`, `pmma_student_id`, `last_name`, `first_name`, `middle_name`, `email`, `contact_number`, `date_of_birth`, `age`, `gender`, `school`, `region`, `exam_venue`, `exam_date`, `email_verified`, `address`, `nationality`, `password`, `status`) VALUES
(1, NULL, NULL, 'Bernandino', 'Cezar', 'I', 'ernandinocezar@gmail.com', 963288424, '2003-02-12', 22, '', NULL, NULL, NULL, NULL, 0, 'P-3 Lugui LCN', '', 'cezar1212', ''),
(2, NULL, NULL, 'Almadrones', 'Lee Ivan', 'O', 'leeivanalmadrones6@gmail.com', 2147483647, '2004-09-10', 21, '', NULL, NULL, NULL, NULL, 0, 'Purok 3 Lugui Labo Camarines Norte', '', '$2y$10$S.dQ1huZ/X25vFuRwsC8qOaGN1ISJ//t/lVRNxH8Zl5E0OuEGWdi6', ''),
(3, '09-0909-09', '22-1512', 'Bernandino', 'Cezar', 'I', 'cezarbernandino12@gmail.com', 90908777, '2026-02-03', 18, 'Male', NULL, NULL, NULL, NULL, 0, 'Labo CN', 'FIlipino', '$2y$10$aVHzKHAZFsXnhg/Qbu6FfO1p9zLwoyJ1Y7NlXbSSK9xnXK7/Dftj2', ''),
(6, NULL, NULL, 'Bernandino', 'Cezar', 's', 'bernandinoceza@gmail.com', 963234542, '2026-02-11', 0, 'male', NULL, NULL, NULL, NULL, 0, '', '', '$2y$10$hJJf7rVeavqbaEENsKOMEeZNQdE/buYQhXT5Rn6EUePaZUBy9hKOe', ''),
(15, NULL, NULL, 'Bernandino', 'Ceza', 's', 'bernandinocear@gmail.com', 963234542, '2026-02-11', 0, '', NULL, NULL, NULL, NULL, 0, '', '', '$2y$10$3/VyMuYldB8.vWPq1CCjd.1wL57Tj2GLUAPfth1WU9nIHJGT9SUXu', ''),
(18, NULL, NULL, 'Bernando', 'Cezar', 'I', 'bernandocezar@gmail.com', 963234542, '2026-02-11', 0, '', NULL, NULL, NULL, NULL, 0, '', '', '$2y$10$VP4STuI94nNvGvhUNuOFDu.I//pUPZDktMSVIgBa99OpaPsBlpU2.', ''),
(20, NULL, NULL, 'onidnanreb', 'Cezarrrr', 's', 'bernandinicezar@gmail.com', 963234542, '2026-02-11', 0, 'male', NULL, NULL, NULL, NULL, 0, '', '', '$2y$10$EMlfA8JAk.hKfo3PSWxwqeEmNJ8PHB0pKPSWqv7tE5Ik.g6P/hVNq', ''),
(21, NULL, NULL, 'onidnanreb', 'Cezarrrr', 's', 'nandinocezar@gmail.com', 963234542, '2026-02-12', 0, 'male', NULL, NULL, NULL, NULL, 0, '', '', '$2y$10$piPzS1RXw58S7Yep5ObS9.yPRveFNJ9sTKESPl.4eh/kuzyrQztt2', '');
